...
(function () {
  'use strict';
    ...
    function extractClubId() { //카페별로 링크저장을 위해 ClubId추출
        try {
    ...
    function markReadArticles() {
        ...
        articleLinks.forEach(a => {
            ...
            const ignoreAncestor = a.closest('.ArticleBottomBtns'); //하단 글쓰기,답글버튼 제외
            if (ignoreAncestor) return;
